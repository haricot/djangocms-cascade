    ...
    def __new__(cls, *args):
        ...
        for arg in args:
            if isinstance(arg, property):
                ...
                form_name = "{}Form".format( property_name)
                icon_name = "icon-{}-title".format(property_name)

        forms={}
        for key , items_fields in form_fields_by_property_name.items():
        ...
        utility_form_mixin = type('UtilitiesFormMixin', (EntangledModelFormMixin,), dict(nested_form_fields, Meta=Meta) )
